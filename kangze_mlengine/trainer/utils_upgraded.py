...
def log_scalar(name, val, logging_frequency=1):
    ...
    :return:
    """
    # with tf.compat.v1.summary.record_summaries_every_n_global_steps(logging_frequency):
    tf.compat.v1.summary.scalar(name, val)
    # writer.add_summary(tf.compat.v1.summary.scalar(name, val))
